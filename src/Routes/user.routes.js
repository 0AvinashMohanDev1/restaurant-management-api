...
// Route to get a user via its Id
router.get("/:username",async(req,res)=>{
  try {
    ...
    console.error(`Error during getting user`,error.message);
    res.status(404).json({error});
  }
})

// Route to create a user as a manager
router.post('/signup', authenticateToken, authorizeManager, async (req, res) => {
  try {
